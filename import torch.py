...
class EncoderDecoder(torch.nn.Module): 
	...
	def forward(self, src, tgt, src_mask, tgt_mask): 
		'''pass src and tgt through encoder and decoder'''
...
class Generator(torch.nn.Module): 
	...
	'''class for linear + softmax output after decoder'''

	def __init__(self, d_model, vocab): 
		super(Generator, self).__init__()
		self.proj = torch.nn.Linear(d_model, vocab) # project decoder output to the size of the vocab 
...
class Encoder(torch.nn.Module): 
	'''Encoder class of N identical layers'''
...
class MultiHeadAttention(torch.nn.Module):
	...
	def __init__(self, h, d_model, dropout=0.1):
		'take in d_model and number of heads'
